...
class Agent(object):
    ...
    def update_sac(self, replay_buffer):
        ...
        for _ in tf.range(update_count):
            ...
            grad2 = tape.gradient([var_loss], self.model.q1.trainable_variables + self.model.q2.trainable_variables)

            self.train_pi.apply_gradients(zip(grad, self.model.policy.trainable_variables))
            self.train_q.apply_gradients(zip(grad2, self.model.q1.trainable_variables + self.model.q2.trainable_variables))
            ...
            # self.train_pi.minimize(pi_loss, var_list=[self.model.policy.trainable_variables], tape=tape)
            ...
            # self.train_q.minimize(var_loss, var_list=[self.model.q1.trainable_variables, self.model.q2.trainable_variables], tape=tape)
